...
export default {
    name: "asahotak",
    command: ["asahotak", "helpao"],
    tags: "games",
    desc: "Guess game asahotak.",
    customPrefix: "",
    example: "",
    limit: false,
    isOwner: false,
