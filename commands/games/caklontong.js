...
export default {
    name: "caklontong",
    command: ["caklontong", "helpcl"],
    tags: "games",
    desc: "Guess game caklontong.",
    customPrefix: "",
    example: "",
    limit: false,
    isOwner: false,
