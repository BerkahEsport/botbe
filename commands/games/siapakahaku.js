...
export default {
    name: "siapakahaku",
    command: ["siapakahaku", "helpsa"],
    tags: "games",
    desc: "Guess game siapakahaku.",
    customPrefix: "",
    example: "",
    limit: false,
    isOwner: false,
