...
export default {
    name: "susunkata",
    command: ["susunkata", "helpsk"],
    tags: "games",
    desc: "Guess game susunkata.",
    customPrefix: "",
    example: "",
    limit: false,
    isOwner: false,
