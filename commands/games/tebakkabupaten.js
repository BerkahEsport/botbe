...
export default {
    name: "tebakkabupaten",
    command: ["tebakkabupaten", "helptkab"],
    tags: "games",
    desc: "Guess game tebakkabupaten.",
    customPrefix: "",
    example: "",
    limit: false,
    isOwner: false,
    ...
    before: async(m, {
        ...
        temp = temp || new Map();
        const id = "tebakkabupaten-"+m.from;
