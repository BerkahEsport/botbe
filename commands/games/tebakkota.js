...
export default {
    name: "tebakkota",
    command: ["tebakkota", "helptko"],
    tags: "games",
    desc: "Guess game tebakkota.",
    customPrefix: "",
    example: "",
    limit: false,
    isOwner: false,
