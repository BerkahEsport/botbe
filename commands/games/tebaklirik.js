...
export default {
    name: "tebaklirik",
    command: ["tebaklirik", "helptl"],
    tags: "games",
    desc: "Guess game tebaklirik.",
    customPrefix: "",
    example: "",
    limit: false,
    isOwner: false,
