...
export default {
    name: "tekateki",
    command: ["tekateki", "helptek"],
    tags: "games",
    desc: "Guess game tekateki.",
    customPrefix: "",
    example: "",
    limit: false,
    isOwner: false,
