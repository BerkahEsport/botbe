...
export class Localdb {
  ...
  fetch = async () => {
    if (!fs.existsSync("./lib/json")) {
      fs.mkdirSync("./lib/json");
    }
    if (!fs.existsSync("./lib/json/contacts.json")) {
      fs.writeFileSync("./lib/json/contacts.json");
    }
    if (!fs.existsSync("./lib/json/groupMetadata.json")) {
      fs.writeFileSync("./lib/json/groupMetadata.json");
    }
